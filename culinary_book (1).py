...
def send_welcome(message):
    bot.send_message(message.chat.id, "Привет! Введи ингредиенты, или выбери категорию:\nФормат ввода:\n мука, молоко",
                 reply_markup=create_category_keyboard())


@bot.message_handler(commands=['help'])
def start_message(message):
    bot.send_message(message.chat.id, "Ознакомьтесь с инструкцией: https://clck.ru/3E5g8X")
